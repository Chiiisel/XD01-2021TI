 ...
 */
#if UART1_BUFF_EN == 1
	uint8_t RxDMABuff1[UART_RX_BUF_SIZE] = {0};
#endif

#if UART2_BUFF_EN == 1
	uint8_t RxDMABuff2[UART_RX_BUF_SIZE] = {0};
#endif

#if UART3_BUFF_EN == 1
	uint8_t RxDMABuff3[UART_RX_BUF_SIZE] = {0};
#endif

#if UART4_BUFF_EN == 1
	uint8_t RxDMABuff4[UART_RX_BUF_SIZE] = {0};
#endif

#if UART5_BUFF_EN == 1
	uint8_t RxDMABuff5[UART_RX_BUF_SIZE] = {0};
#endif

#if UART6_BUFF_EN == 1
	uint8_t RxDMABuff6[UART_RX_BUF_SIZE] = {0};
#endif

#if UART7_BUFF_EN == 1
	uint8_t RxDMABuff7[UART_RX_BUF_SIZE] = {0};
#endif
