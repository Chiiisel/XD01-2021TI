...
bool ESP8266_Cmd ( char * cmd, char * reply1, char * reply2, uint32_t waittime )
{
	...
	//	printf3("%s\r\n",UsartType.RX_pData);	//打印esp8266返回的信息
...
void ESP8266_Init(void)
{
	if(ESP8266_AT_Test())
	{
		...
		ESP8266_JoinAP("Don't Use My Net", "D2313..."); //配置连接AP的ssid和password
		HAL_Delay(100);
		ESP8266_Cmd("AT+CIPMUX=0", "OK", NULL, 500);
		ESP8266_Link_Server(enumTCP, "192.168.0.211", "10666", 5);
	}

	else
		UartSendString(&huart3, "esp8266 ERROR");
